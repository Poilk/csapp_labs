...
word f_pc = [
	...
	M_icode == IJXX && M_Cnd && M_ifun != UNCOND && M_valE >= M_valA : M_valE;
	M_icode == IJXX && !M_Cnd && M_ifun != UNCOND && M_valE < M_valA : M_valA;
...
bool D_bubble =
	# Mispredicted branch
	(E_icode == IJXX && e_Cnd && E_ifun != UNCOND && e_valE >= E_valA ) ||
	(E_icode == IJXX && !e_Cnd && E_ifun != UNCOND && e_valE < E_valA ) ||
